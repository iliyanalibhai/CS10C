...
class arithmeticExpression{
  ...
  public:
   ...
   // copy assignment
   arithmeticExpression(const TreeNode &copy) = delete;
   // copy constructor
   arithmeticExpression & operator=(const TreeNode &copy) = delete; 

   // deconstrictor helper function

    void Destructor(TreeNode* curr);
